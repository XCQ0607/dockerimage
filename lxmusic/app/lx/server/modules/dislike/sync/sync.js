...
const mergeList = (socket, sourceListData, targetListData) => {
    return Array.from((0, utils_1.filterRules)(sourceListData + '\n' + targetListData)).join('\n');
};
...
const mergeDataFromSnapshot = (sourceList, targetList, snapshotList) => {
    ...
    const sourceRules = (0, utils_1.filterRules)(sourceList);
    const targetRules = (0, utils_1.filterRules)(targetList);
    if (snapshotList) {
        const snapshotRules = (0, utils_1.filterRules)(snapshotList);
